...
import { BarChartOptionDefaults, PieChartOptionDefaults, XAxisType,
  pieLabelsAsPctProportion, pieLegendSpacer, MapChartOptionDefaults, RowChartOptionDefaults,
...
@Component({
  ...
  templateUrl: './chart-group-imports.component.html',
  styleUrls: ['./chart-group-imports.component.css', '../muuri-grid-group/muuri-grid-group.component.css']
})
export class ChartGroupImportsComponent extends MuuriGridGroupComponent implements OnInit {
  ...
  private _loadChartByCountry() {
    ...
    this.chartByCountry    = new MaterialDcChartModel('importsByCountry');
    this.chartByCountry.title    = 'Imports';
  ...
  private _loadChartByYear() {
    ...
    // Set Title and Subtitle
    this.chartByYear     = new MaterialDcChartModel('importsByYear');
    this.chartByYear.title     = 'Imports';
  ...
  private _loadChartByPartner() {
    ...
    // Set Title and Subtitle
    this.chartByPartner    = new MaterialDcChartModel('importsByPartner');
    this.chartByPartner.title    = 'Imports';
